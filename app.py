...
st.title("🤖 AZE LLM v4 – Assistant autonome et intelligent")
st.info("Dépose un fichier (texte, audio ou vidéo) pour le traiter. Modèle LLM intégré prévu pour version complète (Render/Offline).")
...
user_input = st.chat_input("💬 Pose ta question à l'assistant")
if user_input:
